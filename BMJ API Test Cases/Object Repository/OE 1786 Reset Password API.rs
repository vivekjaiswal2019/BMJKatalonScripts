...
<WebServiceRequestEntity>
   ...
   <name>OE 1786 Reset Password API</name>
   <tag></tag>
...
WS.verifyElementPropertyValue(response, 'error.userMessage', &quot;Email address is invalid. Email : ${emailAddress}&quot;)</verificationScript>
