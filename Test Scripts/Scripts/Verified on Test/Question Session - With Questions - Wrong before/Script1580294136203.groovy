...
WebUI.verifyTextPresent('Humans tell robots what to do', false)

WebUI.verifyTextPresent('People instruct robots how to walk', false)

WebUI.verifyTextPresent('Robots follow the instructions given', false)

WebUI.verifyTextPresent('Robots need instructions on how to walk', false)

WebUI.verifyTextPresent('Workers help robots walk', false)
...
WebUI.check(findTestObject('Page_BMJ OnExamination Assessment Session/DA4 RB'))
