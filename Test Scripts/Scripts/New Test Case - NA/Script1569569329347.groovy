...
WebUI.verifyElementText(findTestObject('MVC Exam Revision/Exam Details text'), 'Your exam was on 05 July 2019')

selenium.click('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'UKCAT\'])[2]/following::li[2]')

WebUI.verifyElementText(findTestObject('MVC Exam Revision/Questions Answered details'), '26')

selenium.click('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'UKCAT\'])[2]/following::li[3]')

WebUI.verifyElementText(findTestObject('MVC Exam Revision/Count of Questions Details'), '26/185')
